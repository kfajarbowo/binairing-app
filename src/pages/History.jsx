...
const History = () => {
    ...
    const penumpang = Math.floor(getAllBookingResult?.totalHarga / getAllBookingResult?.jadwal?.hargaTiket)
                    ...
                    <Col>
                        <div className='mt-3'>
                            ...
                            <div className='d-flex justify-content-between align-items-center'>
                                <h6 style={titleStyle}>{getAllBookingResult[selectedCardIndex]?.jadwal?.jamKeberangkatan}</h6>
                                <h6 style={subparagraphStyle}>Keberangkatan</h6>
                            </div>
                            <p className='mb-0' style={paragraphStyle}>
                            {getAllBookingResult[selectedCardIndex]?.jadwal?.tglKeberangkatan}
                            </p>
                            <p style={paragraphStyle}>
                            {getAllBookingResult[selectedCardIndex]?.jadwal.kotaKeberangkatan?.cityAirport}- Terminal 1A Domestik
                            </p>
                        </div>
                        ...
                        <Row className='d-flex align-items-center'>
                            ...
                            <Col md='auto'>
                                ...
                                {getAllBookingResult[selectedCardIndex]?.jadwal?.maskapai?.kodeMaskapai} - {getAllBookingResult[selectedCardIndex]?.jadwal?.namaMaskapai}
                                </h6>
                                <h6
                                    className='fw-bold mb-4'
                                    style={paragraphStyle}
                                >
                                    {getAllBookingResult[selectedCardIndex]?.jadwal?.maskapai?.kodeMaskapai} - 203
                                </h6>
                                <h6 className='fw-bold' style={paragraphStyle}>
                                    Informasi:
                                </h6>
                        ...
                        <div className='div'>
                            <div className='d-flex justify-content-between align-items-center'>
                                <h6 style={titleStyle}>{getAllBookingResult[selectedCardIndex]?.jadwal?.jamKedatangan}</h6>
                            ...
                            {getAllBookingResult[selectedCardIndex]?.jadwal?.kotaKedatangan?.cityAirport}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div className='d-flex justify-content-between align-items-center'>
                                ...
                                <p style={paragraphStyle}>{getAllBookingResult[selectedCardIndex]?.jadwal?.hargaTiket}</p>
                            </div>
                            <div className='d-flex justify-content-between align-items-center'>
                        ...
                        <div className='d-flex justify-content-between align-items-center'>
                            ...
                            <h4 style={subheadingStyle}>{getAllBookingResult[selectedCardIndex]?.totalHarga}</h4>
                        </div>

                        {
                          getAllBookingResult[selectedCardIndex]?.paid ? (
                            <Button variant="primary" style={buttonStyle}
                            value={getAllBookingResult[selectedCardIndex]?.bookingId} className='my-4 w-100'
