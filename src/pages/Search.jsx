...
function Search() {
  ...
  const { jadwal } = useSelector((state) => state.jadwalTable);
  ...
  const formatTime = (time) => {
    ...
    const formattedMinute = minute.padStart(2);
                ...
                <Card.Body>
                  <div>
                    <div className="pb-3 d-flex justify-content-between align-items-start">
                      <img
                        width={30}
                        src={item?.maskapai?.logoMaskapai}
                        alt=""
                      />
                      <p className="ps-3 m-0">
                        Jet Air - {item?.kelas?.namaKelas}
                      </p>
                      <Col></Col>
                      <Button
                    ...
                    <Row>
                      <Col className="pe-0 d-grid justify-content-center align-content-center">
                        <b>{formatTime(item?.jamKeberangkatan)}</b>
                        <p className="fw-bold">
                          {item?.kotaKeberangkatan?.cityCode}
                        </p>
                      </Col>
                      <Col xs={6}>
                        <p
                          ...
                          style={{ fontSize: "12px" }}
                        >
                          {item?.durasiJam}h {item?.durasiMenit}m
                        </p>
                        <hr className="m-2" />
                        <p
                        ...
                        <div>
                          ...
                          <Col>
                            <div className="mt-3">
                              ...
                              <div className="d-flex justify-content-between align-items-center">
                                <h5 className="fw-bold">
                                  {formatTime(item?.jamKeberangkatan)}
                                </h5>
                                <h6 className="fw-bold">Keberangkatan</h6>
                              </div>
                              <p className="mb-0">
                                {formatDate(item?.tglKeberangkatan)}
                              </p>
                              <p>
                                {item?.kotaKeberangkatan?.cityAirport} -
                            ...
                            <div>
                              ...
                              <p className="fw-bold">
                                {item?.kotaKedatangan?.cityAirport}
                              </p>
                            </div>
